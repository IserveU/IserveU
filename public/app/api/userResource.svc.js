(function() {
	...
	angular
		.module('iserveu')
		.factory('userResource', ['$resource', '$q', '$rootScope', 'authResource', 'refreshLocalStorage', userResource]);

	function userResource($resource, $q, $rootScope, authResource, refreshLocalStorage) {

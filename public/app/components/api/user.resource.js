...
(function(window, angular, undefined) {
  ...
  function UserResource($resource, $q, $rootScope, Auth) {
    ...
    var UserIndex = $resource('api/user', {
      page: '@pnext_page'
    }, {
      query: {
        method: 'GET',
    ...
    function getUser(id) {
      return User.get({
        ...
        if (result.date_of_birth === undefined || result.date_of_birth === null ||

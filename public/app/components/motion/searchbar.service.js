(function() {
  ...
  angular
    .module('app.motions')
    .factory('MotionSearch', MotionSearchFactory);
  MotionSearchFactory.$inject = ['MotionResource', 'MotionIndex', 'MotionDepartmentResource'];
   
  // TODO: needs documentation
  function MotionSearchFactory(MotionResource, MotionIndex, MotionDepartmentResource) {
    ...
    var factory = {
      ...
      searchAll: function(event) {
        ...
        MotionResource.getMotions(data).then(function (result) {
      ...
      searchSpecific: function() {
        ...
        return MotionResource.getMotions(sanitized).then(function(r){
      ...
      getResults: function(filter) {
        ...
        MotionResource.getMotions(filter).then(function (result) {
          MotionIndex._index = result.data;
          MotionIndex._next_page = null;
          factory.searching = false;
        });
    ...
    MotionDepartmentResource.getDepartments().then(function (success) {
      factory._department = success.data
    });

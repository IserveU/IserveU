	...
	function($translateProvider, SETTINGS_JSON){
		...
		// });
			...
			$translateProvider.translations('en', {
				LANG_NAME: "Languages",
				MOTION: jargon ? jargon.en.motion : "Motion",
				MOTIONS: jargon ? jargon.en.motions : "Motions", //depecrated
				...
				WRITTEN: "written ",
				EDITED: "edited ",
				DEPARTMENT:  jargon ? jargon.en.department : "Department",
				DEPARTMENTS:  jargon ? jargon.en.departments : "Departments",
				DISPLAY: "Display",
				...
				CREATE_NEW_MOTION: jargon ? "Create new " + jargon.en.motion : "Create new motion",
				//department state
			...
			$translateProvider.translations('fr', {
				LANG_NAME: "Langue",
				MOTION: jargon ? jargon.fr.motion : "Motion",
				MOTIONS: jargon ? jargon.fr.motions : "Motions",
				...
				WRITTEN: "écris ",
				EDITED: "édité ",
				DEPARTMENT:  jargon ? jargon.fr.department : "Département",
				DEPARTMENTS:  jargon ? jargon.fr.departments : "Départements",
				DISPLAY: "Affichage",
				...
				CREATE_NEW_MOTION: jargon ? "Créer une nouvelle" + jargon.fr.motion : "Créer une nouvelle motion",
				//department state

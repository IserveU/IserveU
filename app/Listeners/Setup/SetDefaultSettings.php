...
class SetDefaultSettings
{
    ...
    public function handle($event)
    {
        ...
        $this->ifNotSetThenSet('jargon.en', [
                    'motion'      => 'Motion',
                    'motions'     => 'Motions',
        ...
        $this->ifNotSetThenSet('jargon.fr', [
                    'motion'      => 'Motion',
                    'motions'     => 'Motions',
        ...
        $this->ifNotSetThenSet('email', [
                'footer' => ['slogan'        => 'Conceived &amp; Forged In Yellowknife, Canada',
